...
parser.add_argument('--N_lab_vals', default=2, type=int) # Number of classes
...
if args.train_mode:
    os.system('rm '+directory+'gen*'+args.desired_format+' 2> /dev/null')
    if not args.load_model:
        os.system('rm '+directory+'out*'+args.desired_format+' 2> /dev/null')
